...
namespace Selenium2.Meridian.Suite
{
    ...
    public class CareerDevelopmentTests : TestBase
    {
        ...
        public CareerDevelopmentTests(string browser)
             : base(browser)
        {
            browserstr = browser;
...

        {
            ...
            _test.Log(Status.Info, "Click on Cancel Search X icon");
            Assert.IsTrue(CareerNavigatorPage.Results.SearchFilterCleared()); // Verify the search is cleared and page reloads 
        ...
        public void c_Select_DeSelect_Star_On_Job_Card_33657()
        {
            ...
            //Assert.IsTrue(CareerNavigatorPage.StarIconJobCard.HighlightedWithColor);
            Assert.IsTrue(Driver.comparePartialString("The changes were saved", CareerNavigatorPage.GetSuccessMessage()));//, "Error message is different");
            ...
            _test.Log(Status.Info, "Click on star icon ");
            // Assert.IsTrue(CareerNavigatorPage.StarIconJobCard.JobCardWithoutColor); //Verify the Star icon and Job Card styling reverts back to default deselected state 
            Assert.IsTrue(Driver.comparePartialString("The changes were saved", CareerNavigatorPage.GetSuccessMessage()));
            _test.Log(Status.Info, "Verify successful message");
            CommonSection.Learn.CareerDevelopment();
            _test.Log(Status.Info, "Open Career Development Page");
            Assert.IsTrue(CareerDevelopmentPage.SavedJobsPortlet.JobCardRemoved()); //Verify the selected Job Card is removed from in Saved Jobs Portlet
        ...
        public void f_Learner_View_Secondary_Job_Card_on_Career_Navigator_33695()
        {
            ...
            StringAssert.Contains("PrimaryJobTitle_Demo_2006", CareerNavigatorPage.VerifytextPrimaryJobCard("PrimaryJobTitle_Demo_2006"));
            _test.Log(Status.Info, "Verify Job Title name on job card");
            ...
            StringAssert.Contains("Demo_State 2", CareerNavigatorPage.VerifytextSecondaryJobLevel("Demo_State 2"));
            _test.Log(Status.Info, "Verify Level in a Job Title job card");
        ...
        public void h_Learner_Views_Job_Details_model_on_Career_Navigator_33704()
        {
            ...
            StringAssert.AreEqualIgnoringCase("Save job", CareerNavigatorPage.JobDetailModel.VerifyModalName("Save job"));
...

        {
            ...
            Assert.IsTrue(CareerNavigatorPage.JobDetailModel.SavedJobsToolTipText("Save job")); //Verify the text is changed to Save Job
            _test.Log(Status.Pass, "verify tooltip text of star icon");
            CareerNavigatorPage.JobDetailModel.ModelClosed();
            _test.Log(Status.Info, "Close Job title detail modal");
            Assert.IsTrue(CareerNavigatorPage.JobDetailModel.ModalIsClosed());
        ...
        public void k_Learner_Filter_Results_by_SavedJobs_33730()
        {
            ...
            StringAssert.AreEqualIgnoringCase("JobTitle_ForSavetest", CareerNavigatorPage.VerifyJobTitletext("JobTitle_ForSavetest"));
            _test.Log(Status.Info, "Verify Job Title name on job card");
            StringAssert.AreEqualIgnoringCase("rgb(51, 51, 51)", CareerNavigatorPage.VerifyStariconColor("rgb(51, 51, 51)")); //Star Icon as petal color
        ...
        public void l_Learner_Views_SavedJobs_from_CareerDevelopment_Page_33731()
        {
            ...
            StringAssert.AreEqualIgnoringCase("JobTitle_ForSavetest", CareerNavigatorPage.VerifyJobTitletext("JobTitle_ForSavetest"));
            _test.Log(Status.Info, "Verify Job Title name on job card");
            StringAssert.AreEqualIgnoringCase("rgb(51, 51, 51)", CareerNavigatorPage.VerifyStariconColor("rgb(51, 51, 51)"));
            _test.Log(Status.Info, "Verify Saved Jobs icon");
            StringAssert.AreEqualIgnoringCase("Level 1", CareerNavigatorPage.VerifyLeveltext("Level 1"));
            _test.Log(Status.Info, "Verify Level in a Job Title job card");
            StringAssert.AreEqualIgnoringCase("CP_ForSave_Test", CareerNavigatorPage.VerifyCareerPathtext("CP_ForSave_Test"));
...

        {
            ...
            Assert.IsTrue(CareerDevelopmentPage.AddJobsmodelwindow.NameColumn("Name")); // Verify the Name Column is displayed in the modal
            ...
            StringAssert.AreEqualIgnoringCase("JobTitle_ForSavetest", CareerDevelopmentPage.SavedJobsPortlet.VerifyaddedjobtitleText("JobTitle0601114911")); //Verify the Jobs are saved in Saved Jobs Portlet
            ...
            StringAssert.AreEqualIgnoringCase("rgb(51, 51, 51)", CareerNavigatorPage.VerifyStariconColor("rgb(51, 51, 51)"));
            _test.Log(Status.Info, "Verify Saved Jobs icon color");
            CareerNavigatorPage.JobCards.ClickStartIcon();
        ...
        //Prerequisite: Job Title must have assigned competencies which includes the Proficiency Scales, has No Required Content, and has Recommended Content 
        {
            ...
            CommonSection.Learn.CareerDevelopment();
            CareerDevelopmentPage.ClickCompetenciesWithNonRequireContent();
            Assert.IsTrue(CareerDevelopmentPage.CompetencyModal.Display());
            ...
            CareerNavigatorPage.JobDetailModel.ClickCompetenciesCompleteTab();
            Assert.IsFalse(CareerNavigatorPage.JobDetailModel.CompleteTab.ProgressBar.InComplete());//Verify the Progress Bar is displayed as Complete
            CareerNavigatorPage.JobDetailModel.ModelClosed();
            Assert.IsTrue(CareerNavigatorPage.JobDetailModel.ModalIsClosed());
            StringAssert.AreEqualIgnoringCase("Career Explorer", CareerNavigatorPage.VerifySearchText("Career Explorer"));
        ...
        //Prerequisite: Job Title must have assigned competencies which includes the Proficiency Scales, has No Required Content, and has Recommended Content 
        {
            CommonSection.Learn.CareerDevelopment();
            _test.Log(Status.Info, "Open career Development Page");
            CareerDevelopmentPage.ClickCompetenciesWithCompletedRatings();// ClickCompetenciesWithInCompleteRatings();
        ...
        //Prerequisite: Job Title must have assigned competencies which DOES NOT includes the Proficiency Scales, has Required Content, and has Recommended Content 
        {
            ...
            Assert.IsFalse(CareerNavigatorPage.JobDetailModel.CompleteTab.ProgressBar.Complete());//Verify the Progress Bar is displayed as Complete
            CareerNavigatorPage.JobDetailModel.ModelClosed();
            _test.Log(Status.Info, "Close the Job Title modal");
            Assert.IsTrue(CareerNavigatorPage.JobDetailModel.ModalIsClosed());
            _test.Log(Status.Pass, "Verify Job Title Modal is closed");
