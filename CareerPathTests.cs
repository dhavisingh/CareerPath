...
namespace Selenium2.Meridian.Suite
{
    ...
    public class CareerPathTests : TestBase
    {
        ...
        public CareerPathTests(string browser)
             : base(browser)
        {
            browserstr = browser;
        ...
        public void b_Test_when_User_sets_the_active_dates_for_a_career_path_33166()
        {
            ...
            CareersPage.CareerPathTab.CreateCareerPath();
            _test.Log(Status.Info, "Click Create Career Path");
            CreateCareerPathPage.EditCareerPathName(CareerPathTitle+"TC33166");
            _test.Log(Status.Info, "Fill career path name"+ CareerPathTitle + "TC33166");
        ...
        public void c_Test_when_User_searches_for_a_career_path_33168()
        {
            ...
            CareersPage.CareerPathTab.CreateCareerPath();
            _test.Log(Status.Info, "Click Create Career Path");
            CreateCareerPathPage.EditCareerPathName(CareerPathTitle+"TC33168");
            _test.Log(Status.Info, "Fill career path name");
        ...
        {
            CommonSection.Manage.Careerstab();
            _test.Log(Status.Info, "Nevigating to Career Path Tab");
            CareersPage.CareerPathTab.CreateCareerPath();
            _test.Log(Status.Info, "Click on Create Career Path Button");
            CreateCareerPathPage.EditCareerPathName(CareerPathTitle + "TC33566");
            _test.Log(Status.Info, "Fill Create Career Path Title and Save");
           ...
           CareersPage.CreateJobTitle(JobTitle + "TC33566");
            ...
            ManageJobTitlePage.AssignCompetencyFrame.AssignCompetencyItem("CompetencyTitle0105582258");
          
            CommonSection.Manage.Careerstab();
            _test.Log(Status.Pass, "Nevigating to Career Path Tab");
            CareersPage.CareerPathTab.SearchCareerPath(CareerPathTitle + "TC33566");
            _test.Log(Status.Pass, "Search Competency");
            CareersPage.CareerPathTab.ClickSearchResult(CareerPathTitle + "TC33566");
            _test.Log(Status.Pass, "Click on searched Compentenct title");
        ...
        [Test, Order(19)]
        public void s_Create_new_job_title_with_default_value_and_assign_to_a_career_path_33920()
        {
            //login with a admin 
        ...
        public void x_Career_Development_Admin_Config_For_Career_Management_And_Permission_33716()
